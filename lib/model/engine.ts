    ...
    if (inWithdrawal) {
      ...
      if (efGoal?.targetAmount != null && efGoal?.accountId != null) {
        ...
        if (totalPlanned > roomRemaining) {
          const excess = totalPlanned - roomRemaining;
          ...
          rowUnallocatedSurplus = (rowUnallocatedSurplus ?? 0) + excess;
        }
      }
      ...
      if (
        ...
        rowUnallocatedSurplus = (rowUnallocatedSurplus ?? 0) + reconciliationDelta;
